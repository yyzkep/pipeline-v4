...
namespace checksumcrc {
    // lookup table here as `inline static` array
    inline static CRC32_t pulCRCTable[256] = { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba,
    ...
    inline void CRC32_Init(CRC32_t* pulCRC) { *pulCRC = CRC32_INIT_VALUE; }
    inline void CRC32_Final(CRC32_t* pulCRC) { *pulCRC ^= CRC32_XOR_VALUE; }
